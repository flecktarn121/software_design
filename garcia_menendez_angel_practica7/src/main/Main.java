...
public class Main {
	public static void main(String[] args) throws IOException {
		...
		system.copyFile("privado.txt",
				new NormalizedTextOutput(new EncriptedOutput(new FileOutput("copiaEncriptada.txt"))));
		...
		system.copyFile("privado.txt", new NoRepeatedSpacesOutput(
				new NormalizedTextOutput(new EncriptedOutput(new Internet("156.35.33.107")))));
		system.copyFile("privado.txt",
		...
		system.copyFile("privado.txt",
				new EncriptedOutput(new DoubleOutput(new Internet("1.1.1.1"), new Bluetooth("iPhone de César"))));
	}
}
